...
const RAW: { name: string; elo: number; flag: string; aliases: string[] }[] = [
  ...
  { name: "Borussia Dortmund",  elo: 1859, flag: "🇩🇪", aliases: ["Dortmund", "BVB", "B. Dortmund"] },
  ...
  { name: "Atlético Madrid",    elo: 1800, flag: "🇪🇸", aliases: ["Atletico Madrid", "Atlético", "Atletico", "Atleti"] },
  ...
  { name: "Slovan Bratislava",  elo: 1560, flag: "🇸🇰", aliases: ["Slovan", "ŠK Slovan Bratislava", "S. Bratislava"] },
